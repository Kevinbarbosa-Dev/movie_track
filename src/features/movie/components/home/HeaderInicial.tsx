  ...
  return (
    <header className="absolute top-0 left-0 right-0 z-30 bg-transparent ">
      <div className="max-w-7x1 mx-auto flex items-center justify-between px-4 text-white">
        <h1 className="text-lg font-semibold tracking-wide leading-tight line-clamp-2 drop-shadow">
          MovieTrack
        </h1>
        ...
        <nav className="flex gap-2">
          ...
          <Button
            variant="ghost"
            className="rounded-lg text-sm hover:text-gray-700 px-0 leading-tight line-clamp-2 drop-shadow"
          >
            Explorar
          </Button>
          <Button
