...
export const degradeSombraEsquerda =
  "absolute inset-y-0 left-0 w-2/3 bg-gradient-to-r from-black/95 via-black/90 to-transparent pointer-events-none z-20";
...
export const tamanhosBannerThumbnails =
  "w-[170px] md:w-[210px] lg:w-[300px] h-[96px] md:h-[112px] lg:h-[180px]";
